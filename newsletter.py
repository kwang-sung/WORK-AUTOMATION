...
<tr><td style="padding:6px 0;border-bottom:1px solid #f1f5f9;">📩 ALL8 대량/반자동 무료체험 &nbsp;<a href="https://all8.io/" style="color:#6366f1;font-weight:700;text-decoration:none;">바로가기 →</a></td></tr>
<tr><td style="padding:6px 0;border-bottom:1px solid #f1f5f9;">🔗 쿠대 반자동 무료체험 &nbsp;<a href="https://www.coudae.io/" style="color:#6366f1;font-weight:700;text-decoration:none;">바로가기 →</a></td></tr>
<tr><td style="padding:6px 0;border-bottom:1px solid #f1f5f9;line-height:1.8;">🎁 단체방 입장하면 무료로 드려요!<br>🧮 마진 계산기 + 🌐 글로벌 소싱 레이다 v5<br>👉 &nbsp;<a href="https://open.kakao.com/o/gKWnrBDg" style="color:#6366f1;font-weight:700;text-decoration:none;">단톡 무료교육 듣기 →</a></td></tr>
<tr><td style="padding:6px 0;border-bottom:1px solid #f1f5f9;">📍 스레드 &nbsp;<a href="https://www.threads.com/@goldensurfer_kr" style="color:#6366f1;font-weight:700;text-decoration:none;">바로가기 →</a></td></tr>
<tr><td style="padding:6px 0;border-bottom:1px solid #f1f5f9;">📸 인스타 &nbsp;<a href="https://www.instagram.com/goldensurfer_kr/" style="color:#6366f1;font-weight:700;text-decoration:none;">바로가기 →</a></td></tr>
...
<div style="background-color:#f0fdf4;border:1px solid #86efac;border-left:4px solid #16a34a;border-radius:0 12px 12px 0;padding:18px 22px;display:flex;align-items:center;justify-content:space-between;gap:16px;margin:0 0 24px 0;">
  ...
  <div style="display:flex;flex-direction:column;gap:8px;align-items:flex-end;">
    ...
    CTA_BLOG = """<div style="background-color:#0f172a;border-radius:14px;padding:24px 28px;display:flex;align-items:center;justify-content:space-between;gap:16px;border:1px solid #334155;margin:24px 0 8px 0;">
