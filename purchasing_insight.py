...
아래 수집된 정보로 1~2분 안에 읽히는 모바일 최적화 요약 뉴스레터를 작성하세요.
...
4. 🌏 해외 소싱 추천 TOP 3 (각 1문장 + 마진뱃지)
5. 📢 플랫폼 업데이트 2개 (각 1문장)
6. 🏄 골든서퍼 총평 (마치 골든서퍼가 직접 쓴 것처럼 3문장. "이번 주 핵심은..." 으로 시작)
...
- 섹션카드: background-color #f8fafc, border-left 4px solid #e2b04a, padding 14px 16px, margin-bottom 10px, border-radius 0 8px 8px 0
- 섹션제목: font-size 14px, font-weight 800, color #1e293b, margin-bottom 8px
- 본문: font-size 13px, color #475569, line-height 1.7
- 마진뱃지: background-color #dcfce7, color #166534, border-radius 4px, padding 2px 8px, font-size 11px, font-weight 700, display inline-block
- 골든서퍼총평: background-color #1a3a6b, color #ffffff, padding 20px, border-radius 10px, font-size 14px, line-height 1.8, margin-top 16px
- 총평앞: "🏄 골든서퍼의 한마디" 제목, color #e2b04a, font-weight 800, margin-bottom 10px
...
def main():
    ...
    print("📧 메일 발송 중...")
    send_email(summary_html, f"🏄 [요약] 골든서퍼 인사이트 | {today}({weekday})")
