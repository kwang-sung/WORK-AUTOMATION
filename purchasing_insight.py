...
### 소싱처는 반드시 해외 플랫폼만 제시
✅ 중국: 1688, 타오바오, 알리바바, 알리익스프레스, JD닷컴, TEMU, 핀둬둬
✅ 미국: Amazon.com, Nordstrom, Saks Fifth Avenue, Revolve, Sephora, iHerb, B&H, Zappos, REI
✅ 유럽: Zalando, Breuninger, AboutYou, Flaconi, Net-A-Porter, Galaxus, BestSecret
✅ 일본: Rakuten, Amazon.co.jp, ZOZO, Super Delivery, Mandarake, Yahoo쇼핑

❌ 국내 도매몰은 구매대행 소싱처가 아니므로 절대 언급 금지:
   오너클랜, 도매매(domeggook), 도매꾹, 온채널, KSeller, 셀러오션, 신상마켓 등
   → 이들은 국내 B2B 위탁 플랫폼이며, 구매대행 셀러의 소싱처가 아닙니다.
...
3. 📌 이번 주 소싱 기회 — "뭘 팔까?" [전술|소싱아이템]
   - 트렌딩 아이템 3~4개
   - 아이템별: 왜 지금 팔리는지 3~4문장, 소싱처(위 허용 목록의 해외 플랫폼만), 예상 마진율, 주의사항
   - 실전 소싱 팁 박스
