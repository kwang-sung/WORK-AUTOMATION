...
▶ 영상 설명란:
(4~5줄. 공감 한마디 + 영상 내용 + 채널 소개 + 해시태그 5개)

위 5개 항목 전부 빠짐없이 작성하세요.""", 2000)
...
[YouTubeメタデータ作成 - 以下の形式を全て必ず出力すること]
※ 全項目に【한국어】韓国語訳を必ず書くこと。一つでも抜けたら失敗。
...
▶ 動画説明欄:
（4〜5行。共感一言＋内容紹介＋チャンネル紹介＋ハッシュタグ5個）
  【한국어】:

上記5項目、全て빠짐없이 작성하세요。【한국어】も全部 필수입니다。""", 2000)
